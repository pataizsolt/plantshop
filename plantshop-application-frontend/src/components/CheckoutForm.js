                        ...
                        <div className="grid lg:grid-cols-2 sm:px-10 lg:px-20 xl:px-32 ">
                            ...
                            <div className="mt-10 px-4 pt-8 lg:mt-0">
                                ...
                                <div className="">
                                    ...
                                    <div className="relative">
                                        <input type="text" id="phone" name="phone" className="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="+36xxxxxxxxx" />
                                        <div className="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                                    ...
                                    <div className="flex">
                                        <div className="relative w-3/12 flex-shrink-0">
                                        ...
                                        <input type="text" name="street" className="w-4/12 rounded-md border border-gray-200 px-2 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Street" />
                                        <input type="text" name="housenumber" className="w-3/12 rounded-md border border-gray-200 px-2 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="House number" />
                                        <input type="text" name="zip" className="w-2/12 flex-shrink-0 rounded-md border border-gray-200 px-2 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="ZIP" />
                                    </div>
